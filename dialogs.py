...
from customtkinter import (
    ThemeManager, CTkFont,
    CTkToplevel, CTkLabel, CTkEntry, CTkButton
)
from CTkMessagebox import CTkMessagebox

# Code assist from CTkInputDialog, Creds to the owner of CustomTkinter
class PasswordDialog(CTkToplevel):
    def __init__(self,
                 ...
                 title: str = "PasswordDialog",
                 font: Optional[Union[tuple, CTkFont]] = None,
                 text: str = "PasswordDialog") -> None:
    ...
    def _create_widgets(self) -> None:
        ...
        self._entry = CTkEntry(master=self,
                               ...
                               font=self._font,
                               show="*") # Ig the only difference, from the original
...
class MessageBox(CTkMessagebox):
    def __init__(self, master = None,
                 title: str | None = None,
                 message: str | None = None,
                 icon: str = "info") -> None:
        super().__init__(master=master, title=title, message=message, icon=icon,
                         corner_radius=6,
                         border_width=0, border_color="#474747",
                         button_color="#1F6AA5",
                         bg_color="#2B2B2B",
                         text_color="#DCE4EE", title_color="#DCE4EE",
                         button_text_color="#DCE4EE", button_hover_color="#144870")